                ...
                <div className="container log-in-section">
                    ...
                    <div className="log-in-section-form row">
                        <form onSubmit={e => { e.preventDefault(); this.submitUser() }}>
                            <input onChange={(e) =>
                                this.keepInputEmail(e.target.value)}
                                value={this.state.email} className="col-12 mb-4" type="text" placeholder="e.g:email@email.com" required />
                            <input onChange={(e) =>
                                this.keepInputPassword(e.target.value)}
                                value={this.state.password} className="col-12 mb-4" type="password" placeholder="e.g:********" required />
                            <input className="col-12 mb-4 button" type="submit" defaultValue="Sign in" />
                        </form>
                    </div>
