      ...
      <div>
        <HashRouter>
          <div>
            ...
            <Route
              path="/r"
              render={() => <Menu companyName={this.state.companyName} />}
            />
            ...
            <Route
              ...
              render={() => (
                <Events
                  ...
                  sendCompanyName={this.sendCompanyName}
            ...
            <Route
              ...
              render={routeProps => (
                <Sessions sendeventTitle={this.seteventTitle} {...routeProps} />
              )}
            />
            ...
            <Route
              ...
              render={routeProps => (
                <Tickets eventTitle={this.state.eventTitle} {...routeProps} />
              )}
            />
            ...
            <Route
              path="/r/update-user"
              render={() => <UpdateUser userInfo={this.state.user} />}
            />
          </div>
        </HashRouter>
      </div>
