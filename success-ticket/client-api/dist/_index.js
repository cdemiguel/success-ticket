...
var api_client = {
    ...
    loginUser: function loginUser(email, password) {
        return axios.post(this.baseUrl() + '/events/login', { email: email, password: password }).then(function (res) {
            return res.data;
        });
    },
    ...
    createUser: function createUser(name, username, email, password, rol, companyId, eventsId) {
        return axios.post(this.baseUrl() + '/events/usercreate', { name: name, username: username, email: email, password: password, rol: rol, companyId: companyId, eventsId: eventsId }).then(function (res) {
            return res.data;
        });
    }
};
